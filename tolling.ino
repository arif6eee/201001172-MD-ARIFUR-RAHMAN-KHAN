...
void sensorRead()
{
  senVal1 = digitalRead(IR1);
  senVal2 = digitalRead(IR2);
}
...
void rfid()
{
  ...
  if (content.substring(1) == "E2 77 B7 19")
  {
    if (card1Balance >= 500)
    {
      lcdPrint();
  ...
  else if (content.substring(1) == "E2 77 B7 19")
  {
    if (card2Balance >= 500)
    {
      lcdPrint();
